...
downloaded_articles_output_path = repo_root / "_results" / "test" / "pubmed_open_access_files_compressed"
...
decompressed_folder_path = repo_root / "_results" / "test" / "pubmed_open_access_files"
...
pipeline_input_file_path = repo_root / "_results" / "test" / "pubmed_parsed_data.jsonl"
